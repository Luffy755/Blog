...
<main class="form-signin w-100 m-auto">
  <form method="post">
    <div style="text-align:center">
       <a href="home">
          <img class="mb-4 rounded-circle shadow" src="<?=ROOT?>/assets/images/pngegg (7).png" alt="" width="92" height="92" style="object-fit: cover;">
       </a>
    </div>    
    ...
    <div class="form-floating">
      <input value="<?=old_value('password')?>" name="password" type="password" class="form-control from mb-2" id="floatingPassword" placeholder="Password">
    ...
    <div class="form-floating">
      <input value="<?=old_value('retype_password')?>" name="retype_password" type="password" class="form-control from mb-2" id="floatingPassword" placeholder="Retype Password">
    ...
    <div class="form-check text-start my-3">
      <input checked <?=old_checked('terms')?> class="form-check-input" type="checkbox" value="remember-me" id="flexCheckDefault">
      <label class="form-check-label" for="flexCheckDefault">
        Accept terms and condition
      </label>
    </div>
    <?php if (!empty($errors['terms'])): ?>
      <div class="tex-danger"><?=$errors['terms'] ?></div>
    <?php endif; ?>
